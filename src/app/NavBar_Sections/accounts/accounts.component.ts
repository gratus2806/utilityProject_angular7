...
export class AccountsComponent implements OnInit {
  ...
  ngOnInit() {
    this.AccountSearchForm = this.formBuilder.group({
      ...
      bill_Method: ['', Validators.required],
  ...
  onSubmitAccountSearchForm() {
    ...
    this.searchInfo = {
      ...
      bill_Method: this.AccountSearchForm.controls.bill_Method.value,
    ...
    // this.userService.accounts_searchInfo(this.searchInfo).subscribe(data => {
  ...
  selectInput(event) {
    ...
    if (selected == "Utility + Bill Method") {
